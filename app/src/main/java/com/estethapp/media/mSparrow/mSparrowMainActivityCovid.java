...
/*
import static com.esteth.media..data.makeGattUpdateIntentFilter;
import static com.esteth.media.util.App.context;
*/

public class mSparrowMainActivityCovid extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
*/
    //Basic UI for both NewPneu and Covid
...
//        TempView.FakeData();
    ...
    void updateView() {
        ...
        TextView hr_capture = findViewById(R.id.bpm_txt);
        TextView spo_capture = findViewById(R.id.spo2_txt);
        TextView temp_capture = findViewById(R.id.temp_txt);
        ...
        if (!calculateHROO(BPMView.getAvgReading(), 10, 230).equals("--")){
            hr_capture.setText(calculateHROO(BPMView.getAvgReading(),10,230));
        }

        if (!calculateHROO(SPView.getAvgReading(), 10, 100).equals("--")){
            spo_capture.setText(calculateHROO(SPView.getAvgReading(),10,100));
        }



        temp_capture.setText(curTemp+"c");
...
//            respCycle = waveNum / lastX;
            ...
            Log.d("+++HR", calculateHROO(BPMView.getAvgReading(),10,230));
            Log.d("+++SP", calculateHROO(SPView.getAvgReading(),10,100));
            Log.d("+++TP", curTemp + "c");
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.multidevice_capture_covid);
        ...
        if(mDeviceAddress!=null)
            Log.i("MDA", mDeviceAddress);

        if(mDeviceAddress.equals("none")){
            Intent intent = new Intent(mSparrowMainActivityCovid.this, ScanActivity.class);
            mSparrowMainActivityCovid.this.startActivity(intent);
        }
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
//                        Log.d("+++Timer", "This is a timer iteration");
                        //   do your stuff here.
                        //updateTextView();
                        updateView();
                    }
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_presets) {
            ...
            Intent myIntent = new Intent(mSparrowMainActivityCovid.this, ScanActivity.class);
            mSparrowMainActivityCovid.this.startActivity(myIntent);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent intent = new Intent(mSparrowMainActivityCovid.this, MainActivity.class);
        ...
        // their own class later
            ...
            Intent myIntent = new Intent(mSparrowMainActivityCovid.this, SelfAssessmentActivity.class);
            mSparrowMainActivityCovid.this.startActivity(myIntent);
        }
...
*/
    ...
    private void startAutoConnectTimer() {
        ...
        Log.i("__", "startAutoConnectTimer()");
        bluetoothConnectionStatus.setText("Disconnected");

        txtTest.setText("Starting");
        bluetoothConnectionStatus.setText("Connecting...");
        ...
        new CountDownTimer(2000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (msFloor == 4.0) {
//                    Log.i("__", "Attemping to auto connect");
//                    powerButton.callOnClick();
            ...
            public void onFinish() {
                ...
                if (!btConnected) {
                    Log.i("__", " startAutoConnectTimer onFinish()");
...
*/
        ...
        bluetoothConnectionStatus = findViewById(R.id.connection_txt);
    ...
    private void attemptHubReconnect(){
        ...
        new CountDownTimer(timerVal, countDown) {
            ...
            public void onFinish() {
                ...
                if (!isConnected) {
                    Log.i("__", "reconnectTimer onFinish()");
                    txtTest.setText("Disconnected");
                    bluetoothConnectionStatus.setText("Disconnected");
                }
                powerButton.setEnabled(true);
    ...
    private void processHubResults(final byte[] txValue) {
        ...
        try {
            ...
            if(lines.length>2) {
                ...
                if(EXTENDED_DEBUG) Log.d(TAG, "Extrac Lines from Data Stream.. : [" + mDeviceDataLine + "]");
...
*/
                    ...
                    bluetoothConnectionStatus.setText("Connected");
...
//                            String text = new String(txValue, "UTF-8");
                ...
                case R.id.powerButton:
                    ...
                    if (!mBtAdapter.isEnabled()) {
                        ...
                        try {
                            ...
                            Log.i("__", "onClick connected but disconnected");
                            txtTest.setText("Disconnected");
                ...
                case R.id.btnHubCapture:
                    ...
                    h.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            Intent myIntent = new Intent(mSparrowMainActivityCovid.this, MultiResultsActivity.class);
                            mSparrowMainActivityCovid.this.startActivity(myIntent);
                        }
    ...
    public void beginSaveProcess(View view){
        ...
        String path = MediaStore.Images.Media.insertImage(getContentResolver(), bmp, "covid - " + Calendar.getInstance().getTime(), null);

        //Intent to the SaveData page, passing data context and image path
        Intent intent = new Intent(mSparrowMainActivityCovid.this, ActivitySaveData.class);
        intent.putExtra("DATA_CONTEXT", "COVID-19");
