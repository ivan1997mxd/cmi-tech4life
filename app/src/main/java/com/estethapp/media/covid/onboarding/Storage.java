...
public class Storage extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        View fragment = inflater.inflate(R.layout.storage_fragment, container, false);

        fragment.findViewById(R.id.storage_allow_button).setOnClickListener(this);
    ...
    {
        if (view.getId() == R.id.storage_allow_button)
        {
            if (getContext() instanceof BlueToothActivity)
            {
                SystemInterface.AcquirePermission((BlueToothActivity)getContext(), Manifest.permission.READ_EXTERNAL_STORAGE, new PermissionCallback()
                {
                    @Override
