...
/**
 * Created by Irfan Ali on 1/21/2017.
 */
public class ExminatingHelper {

    public static ExminatingHelper instance;
    ...
    private boolean postionArray[] =

            {front_Lungs_Rt_upper_field_1, front_Lungs_Rt_upper_field_2, front_Lungs_Rt_middile_field,
                    front_heart_pulmonic_valve, front_heart_erbpoint,
            front_heart_tricuspidvalve, front_Lungs_Rt_lower_field, front_heart_aortic_valve,
                    front_heart_mitral_valve, front_lungs_lt_lower_field, front_lungs_lt_upper_field};
    ...
    public static ExminatingHelper getInstance() {
        if (instance == null) {
            instance = new ExminatingHelper();
        }
        return instance;
    }
    ...
    public void saveEximatiningInfo(String fileName, SharedPreferences prefsInstance) {
        ...
        Util.scanMediaFiles(App.context, fileName);
